...
# cmd: /Library/Frameworks/Python.framework/Versions/3.10/bin/usbrply --wrapper --device-hi -p s1.pcapng
...
def main():
    ...
    dev.resetDevice()
    replay(dev)
    move_stepper_motor(dev, 100)
    print(f'Stepper Position: {fli_getsteppos(dev)}')
